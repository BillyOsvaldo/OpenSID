<html>
	...
	<body>
      ...
      <link href="<?= base_url()?>assets/css/surat.css" rel="stylesheet" type="text/css" />
				...
				<page orientation="portrait" format="210x300" style="font-size: 9pt">
					...
					<p style="text-align: center; margin-top: 2px; padding: 0px; border: 0px;">
						<strong style="font-size: 12pt;">FORMULIR ISIAN DATA PENDUDUK</strong><br>
					...
					<table class="disdukcapil" style="margin-top: -5px; border: 0px;">
						...
						<tr>
							...
							<?php for ($i=0; $i<13; $i++): ?>
								<td class="kotak padat tengah">
									<?php if (isset($data['alamat'][$i])): ?>
										<?= strtoupper($data['alamat'][$i]);?>
									<?php else: ?>
										&nbsp;
									<?php endif; ?>
								</td>
					...
					<table class="disdukcapil" style="margin-top: 0px; border: 0px;">
						...
						<tr>
							...
							<td>:</td>
								...
								<?php
									$tgl = date('dd',strtotime($data['tanggallahir']));
									$bln = date('mm',strtotime($data['tanggallahir']));
									$thn = date('Y',strtotime($data['tanggallahir']));
									?>
						...
						<tr>
							...
							<?php for ($i=0; $i<16; $i++): ?>
								<td class="kotak padat tengah">
									<?php if (isset($data['tempatlahir'][$i])): ?>
										<?= $data['tempatlahir'][$i];?>
									<?php else: ?>
										&nbsp;
									<?php endif; ?>
						...
						<tr>
							...
							<?php for ($i=0; $i<16; $i++): ?>
								<td class="kotak padat tengah">
									<?php if (isset($data['status'][$i])): ?>
										<?= strtoupper($data['status'][$i]);?>
									<?php else: ?>
										 &nbsp;
									<?php endif; ?>
								</td>
						...
						<tr>
							...
							<td>:</td>
							<td class="kotak padat tengah"><?= $data['wn_id'] ? $data['wn_id'] : '1';?></td>
							...
							<td>:</td>
							<td colspan="21" class="kotak"><?= strtoupper($data['pekerjaan'])?></td>
							<td colspan="2">&nbsp;</td></tr>
						<tr>
							...
							<?php for ($i=0; $i<27; $i++): ?>
								<td class="kotak padat tengah">
									<?php if (isset($data['nama_ayah'][$i])): ?>
										<?= strtoupper($data['nama_ayah'][$i]);?>
									<?php else: ?>
										 &nbsp;
									<?php endif; ?>
								</td>
						...
						<tr>
							...
							<?php for ($i=0; $i<27; $i++): ?>
								<td class="kotak padat tengah">
									<?php if (isset($data['nama_ibu'][$i])): ?>
										<?= strtoupper($data['nama_ibu'][$i]);?>
									<?php else: ?>
										 &nbsp;
									<?php endif; ?>
								</td>
					...
					<table id="ttd" class="disdukcapil" style="margin-top: 15px; margin-bottom: 0px; padding: 0px; border: 0px; border-collapse: collapse;">
						...
						<tr>
							...
							<td colspan="15" style="text-align: center;">(..........................)</td>
							<td colspan="15" style="text-align: center;"><strong>(&nbsp;<?= padded_string_center(strtoupper($data['nama']),30)?>&nbsp;)</strong></td>
						</tr>
