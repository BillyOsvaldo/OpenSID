...
<tr><td>Alamat/ Tempat Tinggal</td><td>:</td><td> <?php echo ucwords(strtoupper($data['alamat']))?> RT. <?php echo $data['rt']?> RW. <?php echo $data['rw']?> Dusun <?php echo $data['dusun']?> Desa <?php echo $desa['nama_desa']?> Kecamatan <?php echo $desa['nama_kecamatan']?> Kabupaten <?php echo $desa['nama_kabupaten']?></td></tr>
</table>
<table width="100%">
