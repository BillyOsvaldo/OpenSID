<?php if (!defined('BASEPATH')) exit('No direct script access allowed');
    ...
    $input['alamat_ibu']    				= trim($ibu['alamat'].' Dusun '.$ibu['dusun']);
    $input['rt_ibu']    						= $ibu['rt'];
    $input['rw_ibu']    						= $ibu['rw'];
    ...
    $input['provinsiibu']   				= $config['nama_propinsi'];
	    ...
	    $input['alamat_ayah']    					= trim($ayah['alamat'].' Dusun '.$ayah['dusun']);
    ...
    $input['alamat_pelapor']    		= trim($pelapor['alamat'].' Dusun '.$pelapor['dusun']);
    ...
    $input['alamat_saksi1']    			= trim($saksi1['alamat'].' Dusun '.$saksi1['dusun']);
    ...
    $input['alamat_saksi2']    			= trim($saksi2['alamat'].' Dusun '.$saksi2['dusun']);
