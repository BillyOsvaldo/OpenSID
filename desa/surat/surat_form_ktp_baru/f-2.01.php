...
<page orientation="portrait" format="210x330" style="font-size: 10pt">
	...
	<table id="kop" class="disdukcapil" style="border: 0px;">
		...
		<tr>
			...
			<td colspan="11"><?= strtoupper($config['nama_kabupaten']);?></td>
		</tr>
		<tr>
			<td class="kotak padat">
					&nbsp;
			...
			<td>: </td>
			<td colspan="11"><?= strtoupper($config['nama_kecamatan']);?></td>
		</tr>
		<tr>
			<td class="kotak padat">
					&nbsp;
			...
			<td>: </td>
			<td colspan="11"><?= strtoupper($config['nama_desa']);?></td>
		</tr>
		<tr>
			<td colspan="25">&nbsp;</td>
	...
	<table class="disdukcapil" style="margin-top: -5px; border: 0px;">
		...
		<tr>
			...
			<?php for ($i=0; $i<13; $i++): ?>
				<td class="kotak padat tengah">
					<?php if (isset($input['alamat_bayi'][$i])): ?>
						<?= strtoupper($input['alamat_bayi'][$i]);?>
					<?php else: ?>
						&nbsp;
					<?php endif; ?>
				</td>
	...
	<table class="disdukcapil" style="margin-top: 0px; border: 0px;">
		...
		<tr>
			...
			<?php for ($i=0; $i<16; $i++): ?>
				<td class="kotak padat tengah">
					<?php if (isset($input['status_kawin'][$i])): ?>
						<?= strtoupper($input['status_kawin'][$i]);?>
					<?php else: ?>
						 &nbsp;
					<?php endif; ?>
				</td>
		...
		<tr>
			...
			<td>:</td>
			<td class="kotak padat tengah"><?= $input['wn_bayi'] ? $input['wn_bayi'] : '1';?></td>
			...
			<td>:</td>
			<td colspan="21" class="kotak"><?= strtoupper($input['pekerjaan'])?></td>
			<td colspan="2">&nbsp;</td></tr>
		<tr>
	...
	<table id="ttd" class="disdukcapil" style="margin-top: 15px; margin-bottom: 0px; padding: 0px; border: 0px; border-collapse: collapse;">
		...
		<tr>
			...
			<td colspan="15" style="text-align: center;">(..........................)</td>
			<td colspan="15" style="text-align: center;"><strong>(&nbsp;<?= padded_string_center(strtoupper($input['nama_bayi']),30)?>&nbsp;)</strong></td>
		</tr>
